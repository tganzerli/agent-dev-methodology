...
9. ❌ A `docs/<id>__knowledge` branch that touches code (`apps/*/lib/`, `apps/*/test/`, `packages/*/lib/`, `packages/*/test/`, any app/package manifest, lockfiles). The diff must be 100% inside the knowledge layer (`knowledge_source_of_truth_rule.md` §2). The root workspace manifest, `scripts/`, CI pipeline config, and `qa/` **are** knowledge layer and may be touched here.
